...
public class barChartWebServices extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar_title.setText("WEB SERVICES");
        toolbar.setTitle("");
